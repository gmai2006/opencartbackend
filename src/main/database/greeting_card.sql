...
truncate table oc_product_desciption;
...
(5, 'quillingartist.com', 'catalog/demo/htc_logo.jpg', 0);
...
INSERT INTO `oc_user` (user_id,user_group_id,username,password,salt,firstname,lastname,email,image,code,ip,status,date_added) VALUES (1,1,'admin','2923c54ffe66f06d2b984065fbf1600dafc10881','TC4rbKu75','John','Doe','gmai2006@gmail.com','','','127.0.0.1',1,{ts '2016-12-17 13:40:24.000'});
--    --   --   --   --   --   --   --   --   --   --   --   --   --   --   --   --   --   --   --   --   --   --   --   --   --   --   --   --   
